...
convention rather than a law - pass your own function to open a different
viewer.
...
checked rather than assumed: for a 45 km day ride and a 1,000 km tour, the
overlay, the legend and the hover payload it produces are byte-identical to the
output they replaced - down to 29 photo dots merged from 108 photographs, and a
hover table thinned from 3,827 samples to 795.
...
end-to-end specs where this is embedded.
